...
SPELL_FUN              *spell_function( char *name )
{
    ...
    if(!str_cmp(name, "spell_find_familiar")) return spell_find_familiar;
    ...
    if(!str_cmp(name, "spell_dark_blessings")) return spell_dark_blessings;
    ...
    if(!str_cmp(name, "spell_spirit_wolf")) return spell_spirit_wolf;
...
DO_FUN                 *skill_function args( ( char *name ) )
{
    ...
    case 'i':
        ...
        if(!str_cmp(name, "do_items")) return do_items;
    ...
    case 'j':
        ...
        if(!str_cmp(name, "do_join")) return do_join;
        break;
    case 'k':
        if(!str_cmp(name, "do_keen_eye")) return do_keen_eye;
        if(!str_cmp(name, "do_klive")) return do_klive;
    ...
    case 's':
        ...
        if(!str_cmp(name, "do_spirit_travel")) return do_spirit_travel;
        ...
        if(!str_cmp(name, "do_steel_flex")) return do_steel_flex;
    ...
    case 't':
        ...
        if(!str_cmp(name, "do_takeover")) return do_takeover;
    ...
    case 'w':
        ...
        if(!str_cmp(name, "do_whiplash")) return do_whiplash;
...
const char             *spell_name( SPELL_FUN *spell )
{
    ...
    if(spell == spell_find_familiar) return "spell_find_familiar";
    ...
    if(spell == spell_dark_blessings) return "spell_dark_blessings";
    ...
    if(spell == spell_spirit_wolf) return "spell_spirit_wolf";
...
const char             *skill_name( DO_FUN *skill )
{
    ...
    if(skill == do_whiplash) return "do_whiplash";
    ...
    if(skill == do_petscore) return "do_petscore";
    ...
    if(skill == do_steel_flex) return "do_steel_flex";
    ...
    if(skill == do_join) return "do_join";
    ...
    if(skill == do_queststat) return "do_queststat";
    ...
    if(skill == do_klive) return "do_klive";
    ...
    if(skill == do_takeover) return "do_takeover";
    ...
    if(skill == do_items) return "do_items";
    ...
    if(skill == do_spirit_travel) return "do_spirit_travel";
