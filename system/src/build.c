...
const char             *const r_flags[] = {
  ...
  "nofloor", "anchor", "arena", "lighted", "bank", "quest",
  "prototype", "dnd"
};
...
const char             *const w_flags[] = {
  ...
  "sheath", "shoulders", "l_wing", "r_wing"
};
...
const char             *const item_w_flags[] = {
  ...
  "lodge_rib", "lodge_arm", "lodge_leg", "sheath", "shoulders", "l_wing", "r_wing"
};
...
const char             *const o_types[] = {
  ...
  "tool", "stove", "coal", "sheath", "sabotage", "forge", "resource_bag",
  "gather_bag", "hunters_bag", "kit"
};
...
const char             *const a_flags[] = {
  "blindness", "invisible", "courage",
  "detect_invis", "blinding_speed", "detect_hidden",
  "enthralled", "sanctuary", "faerie_fire",
  "infrared", "curse", "shield",  // 12
  "poison", "protect", "paralysis", // 15
  "sneak", "hide", "sleep", // 18
  "charm", "flying", "pass_door", // 21
  "floating", "truesight", "dark_blessings",
  ...
  "thaitin", "shrink", "r45", // 45
  "r46", "surreal_speed", "burrow",
  "age", "silence", "feign", "mana_pool", "maim",
  "reactive", "nettle", "slow", "ward", "anoint",
  "fury", "boost", "hypnotize", "kinetic",
  "unsearing_skin", "iron_skin",  // 64
  "inner_strength", "recoil", "r67",
  "thicken_skin", "root", "keen_eye", "murazor",
  "body", "stirring", "sustain_self", "snare",  // 75
  "ritual", "siphon_strength", "decree_decay",
  "giant_strength", "wizard_sight", "grendals_stance", "aura_life",
  "acidic_touch", "tangled", "flaming_shield", "greater_restore", // 86
  "energy_containment",
// afflictions
  "fungal_toxin",
  "blistering", "clumsiness", "confusion", "dizziness", "nausea", "migraine",
  "frost_bite", "rotten_gut", "brittle_bones", "swelling", "ethereal",
  "neurotoxin", "toxin", "corrosive", "venom_toxin", "highermagic", // 104
  "ptalons", "battlefield", "diseased", "dragonlord", "hate", "crafted_food1", "crafted_food2", // 111
  "crafted_food3", "crafted_drink1", "crafted_drink2", "crafted_drink3", "noscent", "victim", "graze",  // 118
  "graft", "ottos_dance", "sound_waves", "mounted", "phase", "tangle", "armor", // 125
  "disguise", "animalform", "infectious_claws", "sage_wisdom", "ogre_vitality", // 128
  // MAX
  "gamblers_luck", "goblin_cunning", "elven_features", "feline_grace", "imprisoned", "quick_blade", "adrenaline", "maintain_position", "hunker_down", "sprout_spikes",
  "hawk_spirit", "wolf_spirit", "enlarge", "insane", "beastmeld", "searing_haze", "takeover", "r148", "r149", "r150",
  "r151", "r152", "r153", "angelic_being", "valtors_song", "talkup", "telepathy", "disabled", "magic_missile", "willow_skin"
};

const char             *const act_flags[] = {
  "npc", "sentinel", "scavenger", "water", "noquest",
  "aggressive", "stayarea", "wimpy", "pet", "empty1",
  ...
  "questgiver", "sigilist", "craftshop", "shipwright", "beastmeld",
  "beastpet", "banker"
};
...
const char             *const plr_flags[] = {
  ...
  "deny", "freeze", "thief", "killer", "litterbug", "ansi", "rip", "objid",
  ...
  "boat", "music", "battle", "autowake", "extreme", "norename", "communication", 
  "crafts", "r64", "enhanced", "keepalive",
...
const char             *const wear_locs[] = {
  ...
  "face", "ankle1", "ankle2", "sheath", "shoulders", "l_wing", "r_wing"
};
...
const char             *const attack_flags[] = {
  "bite", "claws", "tail_swipe", "staticpulse", "punch", "kick", "backhand", "lowblow", "stun", "gouge",  // 10
  "backstab", "feed", "drain", "mentalassault", "breathe", "gut", "impale", "frost", "poison", "slow",  // 20 
                                                                                                        // 
  // 
  "throatpunch", "rake", "thaitin", "judochop", "shriekingnote", "murazorwhip", "butterflykick", "snatch", "fireball", "lightning", // 30
  "weaken", "pugilism", "inferno", "blizzard", "ebolt", "blightning", "brainboil", "gsmite", "hhands", "ltouch",  // 40
  "elbow", "corrosive", "headbutt", "flyby", "blurattack", "cranekick", "critic", "psionicblast", "ferociousstrike", "pluck", // 50
  "acidspray", "swarm", "astralattack", "paralyze", "fear", "stomp", "bodydrop", "mistacid", "creepingdoom", "arteries",  // 60
  "spike", "quiveringpalm", "thunderoushymn", "a_24", "a_25", "a_26", "a_27", "a_28", "a_29", "a_30", // 70
  "max"
};

const char             *const defense_flags[] = {
  "parry", "dodge", "nettleskin", "spectralward", "torpor", "kineticbarrier",
  "dispelmagic", "hawkspirit", "sanctuary", "lick", "combatheal",
  "shield", "willowskin", "grendalstance", "wolfspirit", "regenerate", "maintainposition", "biofeedback",
  "hunkerdown", "disarm", "findweakness", "bearspirit", "minorrestore", "acidmist", "r25",
  "r26", "r27", "r28", "r29", "r30",
  "r31", "r32", "r33"
};
...
void do_goto(CHAR_DATA *ch, char *argument)
{
  ...
  {
    send_to_char("That would affect your height in the negative you will need to stand first.\r\n", ch);
    return;
  }
  ...
  if(!str_cmp(arg, "next") || !str_cmp(arg, "prev"))
  {
    ...
    {
      bug("%s: %s is not in a room... um... this is BAD", __FUNCTION__, ch->name);
      return;
    }
  ...
  if(!is_number(arg) && (fch = get_char_world(ch, arg)))
  {
    if(str_cmp(ch->name, "Vladaar"))
      if(!IS_NPC(fch) && get_trust(ch) < get_trust(fch))
      {
        ...
        pager_printf(fch, "%s has tried to goto you, give them the room vnum if you want them there.\r\n", ch->name);
        return;
      }
  }
  ...
  if(!IS_SET(ch->pcdata->flags, PCFLAG_BUILDWALK) && !IS_NPC(ch))
  {
    ...
    else if(!xIS_SET(ch->act, PLR_WIZINVIS) && ch->level < 108)
    {
      if(!VLD_STR(ch->pcdata->bamfout))
        act(AT_IMMORT, "&C[OoC]: $n please &Rvote&C for us at &Yhttp://6dragons.tk/bin/vote.html &Cthis message suddenly &REXPLODES!&c and $n is GONE!&D", ch, NULL, NULL, TO_ROOM);
      else
  ...
  if(!IS_SET(ch->pcdata->flags, PCFLAG_BUILDWALK) && !IS_NPC(ch))
  {
    ...
    else if(!xIS_SET(ch->act, PLR_WIZINVIS) && ch->level < 108)
    {
      if(!VLD_STR(ch->pcdata->bamfin))
        act(AT_IMMORT, "&C[OoC]: $n please &Rvote&C for us at &Yhttp://6dragons.tk/bin/vote.html &Cthis message suddenly &REXPLODES! &cand $n is standing here!&D", ch, NULL, NULL, TO_ROOM);
      else
...
{
  char                    arg1[MIL], arg2[MIL], arg3[MIL], buf[MSL], outbuf[MSL];
  int                     num, size, plus, v2, value, minattr, maxattr, type;
  char                    char1, char2;
  CHAR_DATA              *victim;
  bool                    lockvictim;
  ...
  switch (ch->substate)
  {
    ...
    case SUB_MOB_DESC:
      if(!ch->dest_buf)
      {
        ...
        bug("%s: sub_mob_desc: NULL ch->dest_buf", __FUNCTION__);
  ...
  if(arg1[0] == '\0' || (arg2[0] == '\0' && ch->substate != SUB_REPEATCMD) || !str_cmp(arg1, "?"))
  {
    ...
    send_to_char("  For mob corpses sliced open objects found : slicevnum (see help slice)\r\n", ch);
    ...
    send_to_char("  hitnumdie hitsizedie hitplus (hit points) damnumdie damsizedie damplus (damage roll)\r\n", ch);
    send_to_char("Monk Players Only: focus\r\n", ch);
    if(ch->level == (MAX_LEVEL))
      send_to_char("PLAYER ONLY: puppet i3 xp dexp recast hull\r\n", ch);
    return;
  }
  ...
  if(get_trust(ch) < LEVEL_AJ_CAPTAIN && IS_NPC(victim) && xIS_SET(victim->act, ACT_STATSHIELD))
  {
    send_to_char("You can't do that!\r\n", ch);
    ch->dest_buf = NULL;
    return;
  ...
  if(!str_cmp(arg2, "dexp"))
  {
    ...
    send_to_char("Done.\r\n", ch);
    ch_printf(ch, "%s now has %d rounds of double exp.\r\n", victim->name, victim->pcdata->double_exp_timer / 100);
    return;
  }

  if(!str_cmp(arg2, "recast"))
  {
    if(!can_mmodify(ch, victim))
      return;
    ...
    if(value < 0 || value > 4)
    {
      send_to_char("Outside of valid dexp range 0 - 4.\r\n", ch);
      return;
    }

    victim->pcdata->recast = (value);
    send_to_char("Done.\r\n", ch);
    ch_printf(ch, "%s now has %d recast.\r\n", victim->name, victim->pcdata->recast);
    return;
  }
#ifdef I3
  if(!str_cmp(arg2, "i3"))
  ...
  if(!str_cmp(arg2, "carry_weight"))
  {
    ...
    {
      ch_printf(ch, "Carry range is 0 to 2000. This is not the MAXIMUM that a player can carry, just the weight they are currently carrying.\r\n");
      return;
    }
  ...
  if(!str_cmp(arg2, "tradeclass"))
  {
    ...
    if(value < -1 || value >= 27)
    {
      ch_printf(ch, "Tradeclass range is 20 to 26, -1 removes tradeclass.\n");
      return;
    }
  ...
  if(!str_cmp(arg2, "armor"))
  {
    ...
    {
      send_to_char("You cannot readjust armor, contact the head of Area Architect for more information.\r\n", ch);
      return;
    }
  ...
  if(!str_cmp(arg2, "level"))
  {
    ...
    {
      send_to_char("Now establishing Hitpoints, ArmorClass, Hitroll/Damroll and NumAttacks.\r\n", ch);
      send_to_char("You need only set the race/class, sex, short/long desc, attacks, bodyparts, affected, and attributes.\r\n", ch);
      send_to_char("If you have a quest mob, or a reason why it needs to be outside autoset, see a Head of Council.\r\n", ch);
    ...
    if(IS_NPC(victim) && xIS_SET(victim->act, ACT_PROTOTYPE) && !xIS_SET(victim->act, ACT_OVERRIDE))
  ...
  if(!str_cmp(arg2, "numattacks"))
  {
    ...
    {
      send_to_char("You cannot readjust numattacks, contact the head of Area Architect for more information.\r\n", ch);
      return;
    }
    if(value < 0 || value > 20)
    {
  ...
  if((type = get_currency_type(arg2)))
  {
    ...
    ch_printf(ch, "%s now has %d %s.\r\n", PERS(victim, ch), GET_MONEY(victim, type), cap_curr_types[type]);
  ...
  if(!str_cmp(arg2, "hitroll"))
  {
    ...
    if(IS_NPC(victim) && ch->level < 106 || !is_head_architect(ch))
    {
      send_to_char("You can't modify hitroll, contact the head of\r\nArea Architect in order to have this value changed.", ch);
      return;
    }
  ...
  if(!str_cmp(arg2, "damroll"))
  {
    ...
    if(IS_NPC(victim) && ch->level < 106 || !is_head_architect(ch))
    {
      send_to_char("You can't modify damroll, contact the head of\r\nArea Architect in order to have this value changed.", ch);
      return;
    }
  ...
  if(!str_cmp(arg2, "hp"))
  {
    ...
    if(IS_NPC(victim) && ch->level < 106 || !is_head_architect(ch))
    {
      send_to_char("You can't modify hitpoints, contact the head of\r\nArea Architect in order to have this value changed.", ch);
      return;
    }
  ...
  if(!str_cmp(arg2, "thirst"))
  {
    ...
    if(value < 0 || value > STATED)
    {
      send_to_char("Thirst range is 0 to 200.\r\n", ch);
      return;
    }
  ...
  if(!str_cmp(arg2, "drunk"))
  {
    ...
    {
      send_to_char("Drunk range is 0 to 200.\r\n", ch);
      return;
    }
  ...
  if(!str_cmp(arg2, "clan"))
  {
    ...
    if(!IS_IMMORTAL(victim))
    {
      ...
      add_roster(victim->pcdata->clan, victim->name,
                 ...
                 victim->pcdata->pkills, victim->pcdata->mkills, victim->pcdata->mdeaths, victim->pcdata->tradeclass, victim->pcdata->tradelevel);
      save_clan(victim->pcdata->clan);
    }
    send_to_char("Done.\r\n", ch);
    return;
  ...
  if(!str_cmp(arg2, "hull"))
  {
    ...
    {
      send_to_char("The captain's ship hull can be set from 0 to 100 percent.\r\n", ch);
      return;
    }
    victim->pcdata->hull = value;
    send_to_char("Ship Hull set.\r\n", ch);
    return;
  }
  ...
  if(!str_cmp(arg2, "flags"))
  {
    ...
    while(argument[0] != '\0')
    {
      ...
      else
      {
        ...
        if(IS_NPC(victim) && value == ACT_PROTOTYPE && get_trust(ch) < LEVEL_AJ_SGT && !is_name("protoflag", ch->pcdata->bestowments))
       ...
       if ( !IS_NPC(victim) && ( !str_cmp( arg3, "r54" ) ))
       {
        OBJ_DATA               *obj;

       victim->pcdata->tradeclass = 20;
       victim->pcdata->tradelevel = 20;
       victim->pcdata->learned[gsn_forge] = 100;
       victim->pcdata->learned[gsn_mine] = 100;
          OBJ_INDEX_DATA         *obj_ind;
          if((obj_ind = get_obj_index(16243)) != NULL)
          {
...
void do_oset(CHAR_DATA *ch, char *argument)
{
  ...
  if(arg1[0] == '\0' || arg2[0] == '\0' || !str_cmp(arg1, "?"))
  {
    ...
    send_to_char("  cflags key capacity city tflags\r\n", ch);
    return;
  }
  ...
  if(!str_cmp(arg2, "extra4"))
  {
    ...
    obj->extra4 = value;
    if(IS_OBJ_STAT(obj, ITEM_PROTOTYPE))
      obj->pIndexData->extra4 = value;
    return;
  }
  if(!str_cmp(arg2, "craft1"))
  {
    if(!can_omodify(ch, obj))
      return;
    obj->craft1 = value;
    if(IS_OBJ_STAT(obj, ITEM_PROTOTYPE))
      obj->pIndexData->craft1 = value;
    return;
  }
  if(!str_cmp(arg2, "craft2"))
  {
    if(!can_omodify(ch, obj))
      return;
    obj->craft2 = value;
    if(IS_OBJ_STAT(obj, ITEM_PROTOTYPE))
      obj->pIndexData->craft2 = value;
    return;
  }
  if(!str_cmp(arg2, "craft3"))
  {
    if(!can_omodify(ch, obj))
      return;
    obj->craft3 = value;
    if(IS_OBJ_STAT(obj, ITEM_PROTOTYPE))
      obj->pIndexData->craft3 = value;
    return;
  }
  if(!str_cmp(arg2, "craft4"))
  {
    if(!can_omodify(ch, obj))
      return;
    obj->craft4 = value;
    if(IS_OBJ_STAT(obj, ITEM_PROTOTYPE))
      obj->pIndexData->craft4 = value;
    return;
  }
  if(!str_cmp(arg2, "craft5"))
  {
    if(!can_omodify(ch, obj))
      return;
    obj->craft5 = value;
    if(IS_OBJ_STAT(obj, ITEM_PROTOTYPE))
      obj->pIndexData->craft5 = value;
    return;
  }
  if(!str_cmp(arg2, "craft6"))
  {
    if(!can_omodify(ch, obj))
      return;
    obj->craft6 = value;
    if(IS_OBJ_STAT(obj, ITEM_PROTOTYPE))
      obj->pIndexData->craft6 = value;
    return;
  }
  if(!str_cmp(arg2, "craft7"))
  {
    if(!can_omodify(ch, obj))
      return;
    obj->craft7 = value;
    if(IS_OBJ_STAT(obj, ITEM_PROTOTYPE))
      obj->pIndexData->craft7 = value;
    return;
  }
  if(!str_cmp(arg2, "craft8"))
  {
    if(!can_omodify(ch, obj))
      return;
    obj->craft8 = value;
    if(IS_OBJ_STAT(obj, ITEM_PROTOTYPE))
      obj->pIndexData->craft8 = value;
    return;
  }
  if(!str_cmp(arg2, "craft9"))
  {
    if(!can_omodify(ch, obj))
      return;
    obj->craft9 = value;
    if(IS_OBJ_STAT(obj, ITEM_PROTOTYPE))
      obj->pIndexData->craft9 = value;
    return;
  }
  if(!str_cmp(arg2, "craft10"))
  {
    if(!can_omodify(ch, obj))
      return;
    obj->craft10 = value;
    if(IS_OBJ_STAT(obj, ITEM_PROTOTYPE))
      obj->pIndexData->craft10 = value;
    return;
  }
  if(!str_cmp(arg2, "craft11"))
  {
    if(!can_omodify(ch, obj))
      return;
    obj->craft11 = value;
    if(IS_OBJ_STAT(obj, ITEM_PROTOTYPE))
      obj->pIndexData->craft11 = value;
    return;
  }
  if(!str_cmp(arg2, "craft12"))
  {
    if(!can_omodify(ch, obj))
      return;
    obj->craft12 = value;
    if(IS_OBJ_STAT(obj, ITEM_PROTOTYPE))
      obj->pIndexData->craft12 = value;
    return;
  }
  if(!str_cmp(arg2, "craft13"))
  {
    if(!can_omodify(ch, obj))
      return;
    obj->craft13 = value;
    if(IS_OBJ_STAT(obj, ITEM_PROTOTYPE))
      obj->pIndexData->craft13 = value;
    return;
  }
  if(!str_cmp(arg2, "craft14"))
  {
    if(!can_omodify(ch, obj))
      return;
    obj->craft14 = value;
    if(IS_OBJ_STAT(obj, ITEM_PROTOTYPE))
      obj->pIndexData->craft14 = value;
    return;
  }
  if(!str_cmp(arg2, "craft15"))
  {
    if(!can_omodify(ch, obj))
      return;
    obj->craft15 = value;
    if(IS_OBJ_STAT(obj, ITEM_PROTOTYPE))
      obj->pIndexData->craft15 = value;
    return;
  }
  if(!str_cmp(arg2, "craft16"))
  {
    if(!can_omodify(ch, obj))
      return;
    obj->craft16 = value;
    if(IS_OBJ_STAT(obj, ITEM_PROTOTYPE))
      obj->pIndexData->craft16 = value;
    return;
  }
  if(!str_cmp(arg2, "craft17"))
  {
    if(!can_omodify(ch, obj))
      return;
    obj->craft17 = value;
    if(IS_OBJ_STAT(obj, ITEM_PROTOTYPE))
      obj->pIndexData->craft17 = value;
    return;
  }
  if(!str_cmp(arg2, "craft18"))
  {
    if(!can_omodify(ch, obj))
      return;
    obj->craft18 = value;
    if(IS_OBJ_STAT(obj, ITEM_PROTOTYPE))
      obj->pIndexData->craft18 = value;
    return;
  }
  if(!str_cmp(arg2, "craft19"))
  {
    if(!can_omodify(ch, obj))
      return;
    obj->craft19 = value;
    if(IS_OBJ_STAT(obj, ITEM_PROTOTYPE))
      obj->pIndexData->craft19 = value;
    return;
  }
  if(!str_cmp(arg2, "craft20"))
  {
    if(!can_omodify(ch, obj))
      return;
    obj->craft20 = value;
    if(IS_OBJ_STAT(obj, ITEM_PROTOTYPE))
      obj->pIndexData->craft20 = value;
    return;
  }
  ...
  {
    send_to_char("You can't set or change glory points on an item, except through the 'glory' command.\r\n", ch);
    return;
  }
  ...
  if(!str_cmp(arg2, "owner"))
  {
    ...
    if(!VLD_STR(arg3))
    {
      send_to_char("Please use oset (obj) owner (name) to set an owner. Owner cleared.", ch);
      STRFREE(obj->owner);
      return;
    }
    ...
    ch_printf(ch, "New owner of this object: %s. Please note, you can NOT set an owner as a prototype.\r\n", arg3);
  ...
  if(!str_cmp(arg2, "city"))
  {
    if(xIS_SET(obj->extra_flags, ITEM_PROTOTYPE))
    {
      send_to_char("You can NOT set an city on prototype objects!\r\n", ch);
      return;
    }

    if(!VLD_STR(arg3))
    {
      send_to_char("Please use oset (obj) city (name) to set a city. City cleared.", ch);
    ...
    obj->whichcity = STRALLOC(arg3);
    ch_printf(ch, "New city set for this object: %s. Please note, you can NOT set an city as a prototype.\r\n", arg3);
  ...
  if(!str_cmp(arg2, "value0") || !str_cmp(arg2, "v0"))
  {
    ...
    {
      send_to_char("Weapon (v1 + v2) and armor (v0 + v1) values are automatically set by the level of the object.\r\nTo override this you must get a council head to add an OVERRIDE flag.\r\n", ch);
      return;
    }
  ...
  if(!str_cmp(arg2, "value1") || !str_cmp(arg2, "v1"))
  {
    ...
    if(obj->item_type == ITEM_WEAPON || obj->item_type == ITEM_ARMOR || obj->item_type == ITEM_MISSILE_WEAPON)
    {
      send_to_char("Weapon (v1 + v2) and armor (v0 + v1) values are automatically set by the level of the object.\r\nTo override this you must get a council head to add an OVERRIDE flag.\r\n", ch);
      return;
    }
...
/*      if(obj->item_type == ITEM_WEAPON && value != 0)
  ...
  if(!str_cmp(arg2, "type"))
  {
    ...
    if((obj->item_type == ITEM_WEAPON || obj->item_type == ITEM_MISSILE_WEAPON) && !IS_OBJ_STAT(obj, ITEM_PROTOTYPE))
    {
      if(obj->value[1] != 0 || obj->value[2] != 0)
      {
        obj->value[1] = 0;
        obj->value[2] = 0;
        send_to_char("You MUST reset objects level in order to auto reset min/max damages.\r\n", ch);
      }
    }
  ...
  if(!str_cmp(arg2, "flags"))
  {
    ...
    while(VLD_STR(argument))
    {
      ...
      {
        if(value == ITEM_PROTOTYPE && get_trust(ch) < LEVEL_AJ_SGT && !is_name("protoflag", ch->pcdata->bestowments))
          send_to_char("You cannot change the prototype flag.\r\n", ch);
        else
        {
 ...
 */
  ...
  if(!str_cmp(arg2, "level"))
  {
    ...
    if(!IS_OBJ_STAT(obj, ITEM_OVERRIDE))
    {
      if(obj->item_type == ITEM_ARMOR)
      {
        ...
        send_to_char("Armor values are autoset, by according to what level you set the object to.\r\nThis may be overridden by a council head if neccessary.\r\n", ch);
      }
      ...
      if(obj->item_type == ITEM_MISSILE_WEAPON)
      {
        ...
        send_to_char
          ("Weapon damages are autoset, by according to what level you set the weapon to.\r\nThis may be overridden by a Council Head if the object is a quest weapon, or special ciircumstance.", ch);
      }
  ...
  if(!str_cmp(arg2, "cost"))
  {
    ...
    {
      send_to_char("You cannot currently edit currtypes, contact the Head of\r\nArea Architects for an override flag.\r\n", ch);
      return;
    }
    obj->cost = value;
    if(IS_OBJ_STAT(obj, ITEM_PROTOTYPE))
...
{
  char                    arg[MIL], arg2[MIL], arg3[MIL], buf[MSL];
...
//  char *arg4[MIL];
  ...
  if(!VLD_STR(arg) || !str_cmp(arg, "?"))
  {
    ...
    send_to_char("  rlist pulltype pull push height owner\r\n", ch);
    return;
  }
  if(!can_rmodify(ch, location))
    return;
  ...
  if(!str_cmp(arg, "owner"))
  {
    if(argument[0] == '\0')
    {
      send_to_char("Set the owner of the room.\r\n", ch);
      send_to_char("Usage: redit owner <name>\r\n", ch);
      return;
    }
    if(VLD_STR(location->owner))
      STRFREE(location->owner);
    location->owner = STRALLOC(argument);
    return;
  }
...
void do_aassign(CHAR_DATA *ch, char *argument)
{
  ...
  if(get_trust(ch) >= LEVEL_AJ_CPL || (is_name(buf, ch->pcdata->bestowments) && get_trust(ch) >= sysdata.level_modify_proto))
  ...
  if((!str_cmp(argument, "tutorial.are") && ch->level < 108) || (!str_cmp(argument, "etutorial.are") && ch->level < 108) || (!str_cmp(argument, "dtutorial.are") && ch->level < 108))
  {
  ...
  if(!tarea)
    for(tmp = first_build; tmp; tmp = tmp->next)
      if(!str_cmp(buf, tmp->filename))
      {
        if(get_trust(ch) >= LEVEL_AJ_CPL || is_name(tmp->filename, ch->pcdata->bestowments) || (ch->pcdata->council && is_name("aassign", ch->pcdata->council->powers)))
        {
          tarea = tmp;
          break;
        }
...
// influence code for areas
  ...
  for(vnum = tarea->low_m_vnum; vnum <= tarea->hi_m_vnum; vnum++)
  {
    ...
    if(pMobIndex->perm_str != 13 || pMobIndex->perm_int != 13
       ...
       || pMobIndex->height != 0 || pMobIndex->weight != 0 || pMobIndex->speaks != 0 || pMobIndex->speaking != 0 || !xIS_EMPTY(pMobIndex->xflags) || pMobIndex->numattacks != 0)
      complexmob = TRUE;
    else
      complexmob = FALSE;
    fprintf(fpout, "#%d\n", vnum);
...
// influence code for areas
    ...
    if(complexmob)
    {
      fprintf(fpout, "%d %d %d %d %d %d %d\n", pMobIndex->perm_str, pMobIndex->perm_int, pMobIndex->perm_wis, pMobIndex->perm_dex, pMobIndex->perm_con, pMobIndex->perm_cha, pMobIndex->perm_lck);
      fprintf(fpout, "%d %d %d %d %d\n", pMobIndex->saving_poison_death, pMobIndex->saving_wand, pMobIndex->saving_para_petri, pMobIndex->saving_breath, pMobIndex->saving_spell_staff);
      fprintf(fpout, "%d %d %d %d %d %d %d\n", pMobIndex->race, pMobIndex->Class, pMobIndex->height, pMobIndex->weight, pMobIndex->speaks, pMobIndex->speaking, pMobIndex->numattacks);
      fprintf(fpout, "%d %d %s %d %d %d ", pMobIndex->hitroll, pMobIndex->damroll, print_bitvector(&pMobIndex->xflags), pMobIndex->resistant, pMobIndex->immune, pMobIndex->susceptible);
  ...
  for(vnum = tarea->low_o_vnum; vnum <= tarea->hi_o_vnum; vnum++)
  {
    ...
    if(pObjIndex->vnum == 16243 || pObjIndex->vnum == 16244 || pObjIndex->vnum == 16245
       || pObjIndex->vnum == 11247 || pObjIndex->vnum == 11248 || pObjIndex->vnum == 11249 || pObjIndex->vnum == 11250 || pObjIndex->vnum == 16246 || pObjIndex->vnum == 35548)
    {
      fprintf(fpout, "%d\n", pObjIndex->craft1);
      fprintf(fpout, "%d\n", pObjIndex->craft2);
      fprintf(fpout, "%d\n", pObjIndex->craft3);
    ...
    if(AREA_VERSION_WRITE > 0)
      switch (pObjIndex->item_type)
      {
        ...
        case ITEM_SCROLL:
          fprintf(fpout, "'%s' '%s' '%s'\n",
                  IS_VALID_SN(pObjIndex->value[1]) ? skill_table[pObjIndex->value[1]]->name :
                  "NONE", IS_VALID_SN(pObjIndex->value[2]) ? skill_table[pObjIndex->value[2]]->name : "NONE", IS_VALID_SN(pObjIndex->value[3]) ? skill_table[pObjIndex->value[3]]->name : "NONE");
          break;
        case ITEM_STAFF:
        case ITEM_WAND:
        ...
        case ITEM_SALVE:
          fprintf(fpout, "'%s' '%s'\n",
                  IS_VALID_SN(pObjIndex->value[4]) ? skill_table[pObjIndex->value[4]]->name : "NONE", IS_VALID_SN(pObjIndex->value[6]) ? skill_table[pObjIndex->value[6]]->name : "NONE");
          break;
      }
...
//      fprintf(fpout, "S %d\n", pObjIndex->size);
    ...
    for(paf = pObjIndex->first_affect; paf; paf = paf->next)
      fprintf(fpout, "A\n%d %d\n", paf->location,
              ((paf->location == APPLY_WEAPONSPELL
                ...
                || paf->location == APPLY_STRIPSN || paf->location == APPLY_RECURRINGSPELL) && IS_VALID_SN(paf->modifier)) ? skill_table[paf->modifier]->slot : paf->modifier);
  ...
  for(vnum = tarea->low_r_vnum; vnum <= tarea->hi_r_vnum; vnum++)
  {
    ...
    if((room->tele_delay > 0 && room->tele_vnum > 0) || room->tunnel > 0 || room->height > 0)
      fprintf(fpout, "1 %d %d %d %d %d %d\n", room->room_flags, room->sector_type, room->tele_delay, room->tele_vnum, room->tunnel, room->height);
    else
...
//    fprintf(fpout, "%d %d\n", room->rarity, room->maxresources);
    ...
    for(xit = room->first_exit; xit; xit = xit->next)
    {
      ...
      if(xit->pull)
        fprintf(fpout, "%d %d %d %d %d\n", xit->exit_info & ~EX_BASHED, xit->key, xit->vnum, xit->pulltype, xit->pull);
      else
    ...
    for(ed = room->first_extradesc; ed; ed = ed->next)
      fprintf(fpout, "E\n%s~\n%s~\n", !ed->keyword ? "" : ed->keyword, !ed->description ? "" : strip_cr(ed->description));
    if(room->mudprogs)
    {
  ...
  for(vnum = tarea->low_m_vnum; vnum <= tarea->hi_m_vnum; vnum++)
  {
    ...
    if((pRepair = pMobIndex->rShop) == NULL)
      continue;
    fprintf(fpout, " %d   %2d %2d %2d         %3d %3d", pRepair->keeper, pRepair->fix_type[0], pRepair->fix_type[1], pRepair->fix_type[2], pRepair->profit_fix, pRepair->shop_type);
...
{
  AREA_DATA              *tarea, *installed;
  char                    filename[256];

  set_char_color(AT_IMMORT, ch);

  if(IS_NPC(ch) || get_trust(ch) < LEVEL_IMMORTAL || !ch->pcdata || (argument[0] == '\0' && !ch->pcdata->area))
  {
    return;
  }
...
void do_foldarea(CHAR_DATA *ch, char *argument)
{
  ...
  if(!str_cmp(argument, "all") && ch->level > 107)
  {
    all = TRUE;
...
void do_aset(CHAR_DATA *ch, char *argument)
{
  ...
  if(!str_cmp(arg2, "derivatives"))
  {
    ...
    snprintf(new_deriv, MSL, "%s%s%s", fDeriv ? tarea->derivatives : "", fDeriv ? " " : "", argument);
...
void do_rlist(CHAR_DATA *ch, char *argument)
{
  ...
  if(IS_NPC(ch) || get_trust(ch) < LEVEL_IMMORTAL || !ch->pcdata || (!ch->pcdata->area && get_trust(ch) < LEVEL_AJ_SGT))
  {
...
*/
  ...
  if(tarea)
  {
    ...
    if((lrange < tarea->low_r_vnum || trange > tarea->hi_r_vnum) && get_trust(ch) < LEVEL_AJ_CPL)
    {
  ...
  for(vnum = lrange; vnum <= trange; vnum++)
  {
    if((room = get_room_index(vnum)) == NULL)
      continue;
    if(vnum < 58000 && vnum > 54000)
    {
      pager_printf(ch, "[%5d][Desc %s][Progs %s] %s %s\r\n", vnum, room->description && strcmp(room->description, "") ? "&GY&D" : "&RN&D", room->mudprogs ? "&GY&D" : "&RN&D", room->name, room->owner);
    }
    else
    {
      pager_printf(ch, "[%5d][Desc %s][Progs %s] %s\r\n", vnum, room->description && strcmp(room->description, "") ? "&GY&D" : "&RN&D", room->mudprogs ? "&GY&D" : "&RN&D", room->name);
    }
  }
  return;
...
void do_olist(CHAR_DATA *ch, char *argument)
{
  ...
  if(tarea)
  {
    ...
    if((lrange < tarea->low_o_vnum || trange > tarea->hi_o_vnum) && get_trust(ch) < LEVEL_AJ_SGT)
    {
      send_to_char("&YThat is out of your vnum range.\r\n", ch);
      return;
    }
  ...
  for(vnum = lrange; vnum <= trange; vnum++)
  {
    if((obj = get_obj_index(vnum)) == NULL)
      continue;
    pager_printf(ch, "[%5d][Desc %s][Prog %s] %-20s '%s'\r\n", vnum, obj->first_extradesc ? "&GY&D" : "&RN&D", obj->mudprogs ? "&GY&D" : "&RN&D", obj->name, obj->short_descr);
...
void do_mlist(CHAR_DATA *ch, char *argument)
{
  ...
  if(tarea)
  {
    ...
    if((lrange < tarea->low_m_vnum || trange > tarea->hi_m_vnum) && get_trust(ch) < LEVEL_AJ_SGT)
    {
      send_to_char("&YThat is out of your vnum range.\r\n", ch);
      return;
    }
  ...
  for(vnum = lrange; vnum <= trange; vnum++)
  {
    if((mob = get_mob_index(vnum)) == NULL)
      continue;
    pager_printf(ch, "[%5d][Lvl %3d][Desc %s][Prog %s] %-20s '%s'\r\n", vnum, mob->level, mob->description ? "&GY&D" : "&RN&D", mob->mudprogs ? "&GY&D" : "&RN&D", mob->player_name, mob->short_descr);
  }
}
...
void do_mpedit(CHAR_DATA *ch, char *argument)
{
  ...
  if(get_trust(ch) < LEVEL_AJ_LT && IS_NPC(victim) && xIS_SET(victim->act, ACT_STATSHIELD))
  {
...
void do_aobjsize(CHAR_DATA *ch, char *argument)
{
  ...
  if(!VLD_STR(arg1))
  {
    ...
    send_to_char("ie 'aobjsize fireant.are 3' would resize all objects in Fire Ant area to 3.\r\n", ch);
    return;
  }
