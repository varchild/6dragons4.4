...
short                   gsn_hex;
short                   gsn_freeze;
short                   gsn_creeping_doom;
short                   gsn_swarm;
short                   gsn_valtors_song;
short                   gsn_morris_dance;
short                   gsn_critic;
short                   gsn_talkup;
short                   gsn_juggle;
short                   gsn_story;
short                   gsn_angelic_being;
short                   gsn_confidence;
short                   gsn_ward_of_ethereal;
short                   gsn_ethereal_attack;
short                   gsn_ethereal_body;
short                   gsn_easy_victim;  // added for mix/bake wilderness
...
short                   gsn_shriek;
short                   gsn_blur_attack;
short                   gsn_blinding_speed;
short                   gsn_quick_blade;
short                   gsn_mistform;
short                   gsn_hypnotize;
...
short                   gsn_sanctuary;
short                   gsn_hardened_scales;
short                   gsn_thick_hide; // animal form
short                   gsn_forward_charge;
short                   gsn_bark_skin;
short                   gsn_infrasion;
short                   gsn_wings;
short                   gsn_grapple;
...
short                   gsn_minor_restore;  // Taon
short                   gsn_acidic_touch; // Taon
short                   gsn_mist_acid;
short                   gsn_acid_spray;
short                   gsn_inner_strength; // Taon
short                   gsn_courage;
short                   gsn_recoil; // Taon
short                   gsn_keen_eye; // Taon
short                   gsn_detect_hidden;
short                   gsn_detect_invis;
...
short                   gsn_dodge;
short                   gsn_hide;
short                   gsn_searing_haze;
short                   gsn_flare;
short                   gsn_torrent;
short                   gsn_iceshard;
short                   gsn_fumes;
short                   gsn_hunker_down;
short                   gsn_maintain_position;
short                   gsn_adrenaline_rush;
short                   gsn_fade;
short                   gsn_smuggle;
...
short                   gsn_butterfly_kick;
short                   gsn_combo;
short                   gsn_coalesce;
short                   gsn_crane_kick;
short                   gsn_knee;
short                   gsn_ferocious_strike;
short                   gsn_elbow;
short                   gsn_bull_spirit;
short                   gsn_bear_spirit;
short                   gsn_wolf_spirit;
short                   gsn_share;
short                   gsn_infectious_claws;
short                   gsn_net;
short                   gsn_hone_claws;
short                   gsn_find_water;
short                   gsn_stalk_prey;
short                   gsn_shroud_spirit;
short                   gsn_tame;
short                   gsn_beast_meld;
short                   gsn_join;
short                   gsn_crushing_jaw;
short                   gsn_maul;
short                   gsn_chilled_touch;
short                   gsn_frost_touch;
short                   gsn_icy_touch;
short                   gsn_chilled_ward;
short                   gsn_frost_ward;
short                   gsn_ice_ward;
short                   gsn_frigid_ward;
short                   gsn_steed;
short                   gsn_static_ward;
short                   gsn_shocking_ward;
short                   gsn_energy_ward;
short                   gsn_lightning_ward;
short                   gsn_poultice;
short                   gsn_tend;
short                   gsn_combat_heal;
short                   gsn_effloresce;
short                   gsn_sylvan_touch;
short                   gsn_mend;
short                   gsn_animal_form;
short                   gsn_bat_form;
...
short                   gsn_bake;
short                   gsn_mix;
short                   gsn_crafted_food1;
short                   gsn_crafted_food2;
short                   gsn_crafted_food3;
short                   gsn_crafted_drink1;
short                   gsn_crafted_drink2;
short                   gsn_crafted_drink3;
...
short                   gsn_find_familiar;
short                   gsn_touch;
short                   gsn_pet_companion;
...
short                   gsn_charge;
short                   gsn_overhead_slash;
short                   gsn_downward_slash;
short                   gsn_meditate;
short                   gsn_trance;
short                   gsn_pluck;
short                   gsn_rake;
...
short                   gsn_frigid_touch; // Vladaar
short                   gsn_devour;
short                   gsn_spike;
short                   gsn_sprout_spikes;
short                   gsn_hawk_spirit;
short                   gsn_gut;
...
/*
    ...
    */
  {
    ...
    if(!load_timedata())
    { /* Loads time from stored file if TRUE - Samson 1-21-99 */
   ...
   */
  {
    ...
    ASSIGN_GSN(gsn_chill, "chill");
    ASSIGN_GSN(gsn_willow_skin, "willow skin");
    ASSIGN_GSN(gsn_pounce, "pounce");
    ASSIGN_GSN(gsn_takeover, "takeover");
    ASSIGN_GSN(gsn_disable, "disable");
    ASSIGN_GSN(gsn_mechanism, "mechanism");
    ASSIGN_GSN(gsn_frost, "frost");
    ASSIGN_GSN(gsn_hex, "hex");
    ASSIGN_GSN(gsn_freeze, "freeze");
    ASSIGN_GSN(gsn_creeping_doom, "creeping doom");
    ASSIGN_GSN(gsn_swarm, "swarm");
    ASSIGN_GSN(gsn_valtors_song, "valtors song");
    ASSIGN_GSN(gsn_morris_dance, "morris dance");
    ASSIGN_GSN(gsn_critic, "critic");
    ASSIGN_GSN(gsn_talkup, "talkup");
    ASSIGN_GSN(gsn_juggle, "juggle");
    ASSIGN_GSN(gsn_story, "story");
    ASSIGN_GSN(gsn_angelic_being, "angelic being");
    ASSIGN_GSN(gsn_confidence, "confidence");
    ASSIGN_GSN(gsn_ward_of_ethereal, "ward of ethereal");
    ASSIGN_GSN(gsn_ethereal_attack, "ethereal attack");
    ASSIGN_GSN(gsn_ethereal_body, "ethereal body");
    ASSIGN_GSN(gsn_easy_victim, "easy victim");
    ASSIGN_GSN(gsn_noscent, "noscent");
    ASSIGN_GSN(gsn_cannibalize, "cannibalize");
    ASSIGN_GSN(gsn_control, "control");
    ...
    ASSIGN_GSN(gsn_toxin, "toxin");
    ASSIGN_GSN(gsn_migraine, "migraine");
    ASSIGN_GSN(gsn_corrosive, "corrosive");
    ...
    ASSIGN_GSN(gsn_blur_attack, "blur attack");
    ASSIGN_GSN(gsn_blinding_speed, "blinding speed");
    ASSIGN_GSN(gsn_quick_blade, "quick blade");
    ASSIGN_GSN(gsn_mistform, "mistform");
    ASSIGN_GSN(gsn_hypnotize, "hypnotize");
    ...
    ASSIGN_GSN(gsn_hardened_scales, "hardened scales");
    ASSIGN_GSN(gsn_thick_hide, "thick hide");
    ASSIGN_GSN(gsn_forward_charge, "forward charge");
    ASSIGN_GSN(gsn_bark_skin, "bark skin");
    ASSIGN_GSN(gsn_wings, "wings");
    ASSIGN_GSN(gsn_infrasion, "infrasion");
    ASSIGN_GSN(gsn_fury, "fury");
    ASSIGN_GSN(gsn_ensnare, "ensnare");
    ASSIGN_GSN(gsn_minor_restore, "minor restore");
    ...
    ASSIGN_GSN(gsn_inner_strength, "inner strength");
    ASSIGN_GSN(gsn_courage, "courage");
    ASSIGN_GSN(gsn_grapple, "grapple");
    ASSIGN_GSN(gsn_martial_arts, "martial arts");
    ASSIGN_GSN(gsn_biofeedback, "biofeedback");
    ASSIGN_GSN(gsn_regenerate, "regenerate");
    ASSIGN_GSN(gsn_serenity, "serenity");
    ...
    ASSIGN_GSN(gsn_mist_acid, "mist acid");
    ASSIGN_GSN(gsn_acid_spray, "acid spray");
    ASSIGN_GSN(gsn_entangle, "entangle");
    ASSIGN_GSN(gsn_vines, "vines");
    ...
    ASSIGN_GSN(gsn_steel_flex, "steel flex");
    ...
    ASSIGN_GSN(gsn_hurl, "hurl");
    ASSIGN_GSN(gsn_target, "target");
    ...
    ASSIGN_GSN(gsn_searing_haze, "searing haze");
    ASSIGN_GSN(gsn_flare, "flare");
    ASSIGN_GSN(gsn_torrent, "torrent");
    ASSIGN_GSN(gsn_iceshard, "iceshard");
    ASSIGN_GSN(gsn_fumes, "fumes");
    ASSIGN_GSN(gsn_hunker_down, "hunker down");
    ASSIGN_GSN(gsn_maintain_position, "maintain position");
    ASSIGN_GSN(gsn_adrenaline_rush, "adrenaline rush");
    ASSIGN_GSN(gsn_fade, "fade");
...
//      Start of custom skills
    ASSIGN_GSN(gsn_butterfly_kick, "butterfly kick");
    ASSIGN_GSN(gsn_combo, "combo");
    ASSIGN_GSN(gsn_coalesce, "coalesce");
    ASSIGN_GSN(gsn_crane_kick, "crane kick");
    ASSIGN_GSN(gsn_knee, "knee");
    ASSIGN_GSN(gsn_ferocious_strike, "ferocious strike");
    ASSIGN_GSN(gsn_elbow, "elbow");
    ASSIGN_GSN(gsn_bull_spirit, "bull spirit");
    ASSIGN_GSN(gsn_bear_spirit, "bear spirit");
    ASSIGN_GSN(gsn_wolf_spirit, "wolf spirit");
    ASSIGN_GSN(gsn_share, "share");
    ASSIGN_GSN(gsn_infectious_claws, "infectious claws");
    ASSIGN_GSN(gsn_net, "net");
    ASSIGN_GSN(gsn_hone_claws, "hone claws");
    ASSIGN_GSN(gsn_find_water, "find water");
    ASSIGN_GSN(gsn_stalk_prey, "stalk prey");
    ASSIGN_GSN(gsn_shroud_spirit, "shroud spirit");
    ASSIGN_GSN(gsn_tame, "tame");
    ASSIGN_GSN(gsn_beast_meld, "beast meld");
    ASSIGN_GSN(gsn_join, "join");
    ASSIGN_GSN(gsn_crushing_jaw, "crushing jaw");
    ASSIGN_GSN(gsn_maul, "maul");
    ASSIGN_GSN(gsn_chilled_touch, "chilled touch");
    ASSIGN_GSN(gsn_frost_touch, "frost touch");
    ASSIGN_GSN(gsn_icy_touch, "icy touch");
    ASSIGN_GSN(gsn_chilled_ward, "chilled ward");
    ASSIGN_GSN(gsn_frost_ward, "frost ward");
    ASSIGN_GSN(gsn_ice_ward, "ice ward");
    ASSIGN_GSN(gsn_frigid_ward, "frigid ward");
    ASSIGN_GSN(gsn_steed, "steed");
    ASSIGN_GSN(gsn_static_ward, "static ward");
    ASSIGN_GSN(gsn_shocking_ward, "shocking ward");
    ASSIGN_GSN(gsn_energy_ward, "energy ward");
    ASSIGN_GSN(gsn_lightning_ward, "lightning ward");
    ASSIGN_GSN(gsn_poultice, "poultice");
    ASSIGN_GSN(gsn_tend, "tend");
    ASSIGN_GSN(gsn_combat_heal, "combat heal");
    ASSIGN_GSN(gsn_effloresce, "effloresce");
    ASSIGN_GSN(gsn_sylvan_touch, "sylvan touch");
    ASSIGN_GSN(gsn_mend, "mend");
    ASSIGN_GSN(gsn_animal_form, "animal form");
    ASSIGN_GSN(gsn_bat_form, "bat form");

    ASSIGN_GSN(gsn_kick, "kick");
    ASSIGN_GSN(gsn_low_blow, "low blow");
    ASSIGN_GSN(gsn_throat_punch, "throat punch");
    ...
    ASSIGN_GSN(gsn_headbutt, "headbutt");
    ...
    ASSIGN_GSN(gsn_gorge, "gorge");
    ASSIGN_GSN(gsn_mine, "mine");
    ASSIGN_GSN(gsn_unearth, "unearth");
    ASSIGN_GSN(gsn_produce, "produce");
    ASSIGN_GSN(gsn_fell, "fell");
    ASSIGN_GSN(gsn_mistwalk, "mistwalk");
    ASSIGN_GSN(gsn_travel, "travel");
    ASSIGN_GSN(gsn_astral_attack, "astral attack");
    ASSIGN_GSN(gsn_forge, "forge");
    ASSIGN_GSN(gsn_mill, "mill");
    ASSIGN_GSN(gsn_jewelry, "jewelry");
    ASSIGN_GSN(gsn_tan, "tan");
    ASSIGN_GSN(gsn_hunt, "hunt");
    ASSIGN_GSN(gsn_mix, "mix");
    ASSIGN_GSN(gsn_crafted_food1, "crafted_food1");
    ASSIGN_GSN(gsn_crafted_food2, "crafted_food2");
    ASSIGN_GSN(gsn_crafted_food3, "crafted_food3");
    ASSIGN_GSN(gsn_crafted_drink1, "crafted_drink1");
    ASSIGN_GSN(gsn_crafted_drink2, "crafted_drink2");
    ASSIGN_GSN(gsn_crafted_drink3, "crafted_drink3");
    ...
    ASSIGN_GSN(gsn_rake, "rake");
    ASSIGN_GSN(gsn_flyby, "flyby");
    ...
    ASSIGN_GSN(gsn_sprout_spikes, "sprout spikes");
    ASSIGN_GSN(gsn_hawk_spirit, "hawk spirit");
...
/* Brain guy skills */
    ...
    ASSIGN_GSN(gsn_spirit_travel, "spirit travel");
    ...
    ASSIGN_GSN(gsn_whiplash, "whiplash");
    ...
    ASSIGN_GSN(gsn_clawed_hands, "clawed hands");
    ...
    if(pHelp->level == tHelp->level && strcmp(pHelp->keyword, tHelp->keyword) == 0)
    {
      ...
      return;
             ...
             strcmp(pHelp->keyword[0] ==
                    '\'' ? pHelp->keyword + 1 : pHelp->keyword, tHelp->keyword[0] == '\'' ? tHelp->keyword + 1 : tHelp->keyword)) < 0 || (match == 0 && pHelp->level > tHelp->level))
    {
      if(!tHelp->prev)
        first_help = pHelp;
      else
...
void load_mobiles(AREA_DATA *tarea, FILE * fp)
{
  ...
  for(;;)
  {
    ...
    {
      bug("%s: vnum %d: letter '%c' not S or C.", __FUNCTION__, vnum, letter);
      shutdown_mud("bad mob data");
      exit(1);
    }
    if(letter == 'C')
    { /* Realms complex mob -Thoric */
...
void load_objects(AREA_DATA *tarea, FILE * fp)
{
  ...
  for(;;)
  {
    ...
    if(area_version >= 10)
    {
      pObjIndex->extra = fread_number(fp);
      pObjIndex->extra2 = fread_number(fp);
      pObjIndex->extra3 = fread_number(fp);
      pObjIndex->extra4 = fread_number(fp);
    }
    if(area_version >= 8
       && (pObjIndex->vnum == 16243 || pObjIndex->vnum == 16244 || pObjIndex->vnum == 16245
    ...
    {
      pObjIndex->craft1 = fread_number(fp);
      pObjIndex->craft2 = fread_number(fp);
      pObjIndex->craft3 = fread_number(fp);
      pObjIndex->craft4 = fread_number(fp);
      pObjIndex->craft5 = fread_number(fp);
      pObjIndex->craft6 = fread_number(fp);
      pObjIndex->craft7 = fread_number(fp);
      pObjIndex->craft8 = fread_number(fp);
      pObjIndex->craft9 = fread_number(fp);
      pObjIndex->craft10 = fread_number(fp);
      pObjIndex->craft11 = fread_number(fp);
      pObjIndex->craft12 = fread_number(fp);
      pObjIndex->craft13 = fread_number(fp);
      pObjIndex->craft14 = fread_number(fp);
      pObjIndex->craft15 = fread_number(fp);
      pObjIndex->craft16 = fread_number(fp);
      pObjIndex->craft17 = fread_number(fp);
      pObjIndex->craft18 = fread_number(fp);
      pObjIndex->craft19 = fread_number(fp);
      pObjIndex->craft20 = fread_number(fp);
    }
  ...
  for(;;)
  {
    ...
    switch (letter)
    {
      default:
        ...
        if(fBootDb)
          boot_log("load_resets: %s (%d) bad command '%c'.", __FUNCTION__, tarea->filename, count, letter);
        return;
...
void load_room_reset(ROOM_INDEX_DATA *room, FILE * fp)
{
  ...
  switch (letter)
  {
    default:
      ...
      if(fBootDb)
        boot_log("%s: Room: %d: %s (%d) bad command '%c'.", __FUNCTION__, room->vnum, room->area->filename, count, letter);
      return;

    case 'M':
      if(get_mob_index(arg1) == NULL && fBootDb)
        boot_log("%s: Room: %d: %s (%d) 'M': mobile %d doesn't exist.", __FUNCTION__, room->vnum, room->area->filename, count, arg1);
      break;

    case 'O':
      if(get_obj_index(arg1) == NULL && fBootDb)
        boot_log("%s: Room: %d: %s (%d) '%c': object %d doesn't exist.", __FUNCTION__, room->vnum, room->area->filename, count, letter, arg1);
      break;
    ...
    case 'P':
      ...
      // some reason it works.
      if(get_obj_index(arg3) == NULL && fBootDb)
        boot_log("%s: Room: %d: %s (%d) 'P': destination object %d doesn't exist.", __FUNCTION__, room->vnum, room->area->filename, count, arg3);
      if(extra > 1)
        not01 = TRUE;
      break;
    ...
    case 'D':
                                                                             ...
                                                                             * * * * * ) */ )
      {
        ...
        bug("Reset: %c %d %d %d %d", letter, extra, arg1, arg2, arg3);
        if(fBootDb)
          boot_log("%s: Room: %d: %s (%d) 'D': exit %d not door.", __FUNCTION__, room->vnum, room->area->filename, count, arg2);
      }

      if(arg3 < 0 || arg3 > 3)
      { /* Volk - changed from 2 to 3 as we now have 3 resets (3 * being * * * * * * * a
         * * * DIG tunnel) */
        bug("%s: Room: %d: 'D': bad 'locks': %d.", __FUNCTION__, room->vnum, arg3);
        if(fBootDb)
          boot_log("%s: Room: %d: %s (%d) 'D': bad 'locks': %d.", __FUNCTION__, room->vnum, room->area->filename, count, arg3);
      }
      break;
    ...
    case 'R':
      if(arg2 < 0 || arg2 > 11)
      {
        ...
        if(fBootDb)
          boot_log("%s: Room: %d: %s (%d) 'R': bad exit %d.", __FUNCTION__, room->vnum, room->area->filename, count, arg2);
        break;
      }
      break;
  }
...
void load_rooms(AREA_DATA *tarea, FILE * fp)
{
  ...
  for(;;)
  {
    ...
    if(area_version >= 9)
    {
      ...
      /*
       * Ok if no pfile, and not already set to Not Assigned, set it to Not
       * Assigned and log it 
       */
      if(VLD_STR(pRoomIndex->owner) && str_cmp(pRoomIndex->owner, "Not Assigned") && !valid_pfile(pRoomIndex->owner))
        log_printf("%s: Room (%d) has owner set to (%s), but there is no pfile to go with it.", __FUNCTION__, vnum, pRoomIndex->owner);
    }
    ...
    if(pArea->nplayer > 0 && pArea->age == (reset_age - 1))
    {
      ...
      for(pch = first_char; pch; pch = pch->next)
      {
        if(!IS_NPC(pch) && IS_AWAKE(pch) && pch->in_room && pch->in_room->area == pArea)
        {
          ...
          // add sound to reset messages
          if(xIS_SET(pch->act, PLR_ENHANCED))
            send_to_char("!!SOUND(sound/scurry.wav)\r\n", pch);
...
OBJ_DATA               *create_object(OBJ_INDEX_DATA *pObjIndex, int level)
{
  ...
  if(pObjIndex->vnum == 16243 || pObjIndex->vnum == 16244 || pObjIndex->vnum == 16245 || pObjIndex->vnum == 11247 || pObjIndex->vnum == 11248 || pObjIndex->vnum == 11249)
  {
    obj->cost = 6;
  }
  ...
  obj->extra = pObjIndex->extra;
  obj->extra2 = pObjIndex->extra2;
  obj->extra3 = pObjIndex->extra3;
  obj->extra4 = pObjIndex->extra4;

  // attempt to save 20 items to crafting bags
  if(pObjIndex->vnum == 16243 || pObjIndex->vnum == 16244 || pObjIndex->vnum == 16245
     || pObjIndex->vnum == 11247 || pObjIndex->vnum == 11248 || pObjIndex->vnum == 11249 || pObjIndex->vnum == 11250 || pObjIndex->vnum == 16246 || pObjIndex->vnum == 35548)
  {
    obj->craft1 = pObjIndex->craft1;
    obj->craft2 = pObjIndex->craft2;
    obj->craft3 = pObjIndex->craft3;
    obj->craft4 = pObjIndex->craft4;
    obj->craft5 = pObjIndex->craft5;
    obj->craft6 = pObjIndex->craft6;
    obj->craft7 = pObjIndex->craft7;
    obj->craft8 = pObjIndex->craft8;
    obj->craft9 = pObjIndex->craft9;
    obj->craft10 = pObjIndex->craft10;
    obj->craft11 = pObjIndex->craft11;
    obj->craft12 = pObjIndex->craft12;
    obj->craft13 = pObjIndex->craft13;
    obj->craft14 = pObjIndex->craft14;
    obj->craft15 = pObjIndex->craft15;
    obj->craft16 = pObjIndex->craft16;
    obj->craft17 = pObjIndex->craft17;
    obj->craft18 = pObjIndex->craft18;
    obj->craft19 = pObjIndex->craft19;
    obj->craft20 = pObjIndex->craft20;
  }
  /*
...
/* Possibly look at adding a check for blind players so if they see
   |*-_~ types of characters it removes them from description - Vladaar */
...
char fread_letter(FILE * fp)
{
  ...
  do
  {
    if(feof(fp))
    {
      bug("%s: fread_letter: EOF encountered on read.\r\n", __FUNCTION__);
      if(fBootDb)
        exit(1);
      return '\0';
    }
...
void do_memory(CHAR_DATA *ch, char *argument)
{
  ...
  ch_printf(ch, "&wMaxEver was recorded on:  &W%ld\r\n\r\n", sysdata.time_of_max);
...
bool new_str_cmp(const char *astr, const char *bstr, const char *filename, int line)
{
  ...
  if(!astr)
  {
    bug("%s: NULL astr [%s] bstr (File: %s Line: %d).", __FUNCTION__, !bstr ? "NULL" : bstr, filename, line);
    return TRUE;
  }
  if(!bstr)
  {
    bug("%s: [%s] astr NULL bstr (File: %s Line: %d).", __FUNCTION__, !astr ? "NULL" : astr, filename, line);
    return TRUE;
  }
...
ROOM_INDEX_DATA        *make_room(int vnum, AREA_DATA *area)
{
  ...
  if(area_version >= 9)
    pRoomIndex->owner = STRALLOC("Not Assigned");
...
{
  char                    Newfilename[MSL], check[MSL];
  ...
  for(;;)
  {
    ...
    else if(!str_cmp(word, "COLOR"))
    { /* Dont really need a seperate function for this * one */
...
void show_vnums(CHAR_DATA *ch, int low, int high, bool proto, bool shownl, const char *loadst, const char *notloadst)
{
  ...
  for(pArea = first_sort; pArea; pArea = pArea->next_sort)
  {
    ...
    pager_printf(ch, "%-15s| Rooms: %5d - %-5d Objs: %5d - %-5d Mobs: %5d - %-5d%s\r\n",
                 ...
                 pArea->low_r_vnum, pArea->hi_r_vnum, pArea->low_o_vnum, pArea->hi_o_vnum, pArea->low_m_vnum, pArea->hi_m_vnum, IS_SET(pArea->status, AREA_LOADED) ? loadst : notloadst);
    count++;
  }
  ...
  for(;;)
  {
    ...
    switch (UPPER(word[0]))
    {
      ...
      case 'G':
        ...
        break;
      case 'H':
        KEY("Happyhour", sys->happy, fread_number(fp));
        ...
        KEY("Highplayertime", sys->time_of_max, fread_time(fp));
...
void do_check_vnums(CHAR_DATA *ch, char *argument)
{
  ...
  for(pArea = first_asort; pArea; pArea = pArea->next_sort)
  {
    ...
    if(area_conflict)
    {
      snprintf(buf, MSL, "Conflict:%-15s| ", (pArea->filename ? pArea->filename : "(invalid)"));
      if(room)
...
void load_storage(char *filename)
{
  ...
  if(!(fp = FileOpen(buf, "r")))
    log_string("Can't load storage %s", buf);
  else
  {
    int                     iNest;
    bool                    found;
    ...
    for(;;)
    {
      ...
      if(letter != '#')
      {
        ...
        resave = TRUE;  /* Save a new one to hopefully fix this issue */
        break;
      }
    ...
    if(resave)  /* If there was a problem with an * * * * * * * object lets resave * * *
                 * after * * all * is * said * * and * * done to * * stop * * * *
                 * repeating * bugs */
...
size_t mudstrlcat(char *dst, const char *src, size_t siz)
{
  ...
  if(!src)
  {
//    bug("%s: %s [%d] passing NULL src string!", __FUNCTION__, src, siz);
    return 0;
  }

  if(!dst)
  {
//    bug("%s: %s [%d] passing NULL dst string!", __FUNCTION__, src, siz);
    return 0;
  }
...
char                   *distime(time_t updated)
{
  ...
  snprintf(buf, sizeof(buf), "%3.3s %3.3s %2d %2d:%.2d:%.2d%2.2s %4.4d",
           wday_name[time->tm_wday], month_name[time->tm_mon], time->tm_mday, hour, time->tm_min, time->tm_sec, am ? "AM" : "PM", (time->tm_year + 1900));
  return buf;
}
