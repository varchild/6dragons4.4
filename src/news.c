...
//    fprintf( fpout, "<link rel="shortcut icon" href=\"http://6dragons.tk/img/tab.ico" type="image/icon"> <link rel="icon" href=\"http://6dragons.tk/img/tab.ico" type="image/icon">" );
  ...
  fptof(fpout,
        "<div class=\"navigation\"><table cellspacing=\"0\" cellpadding=\"0%\"><tr><th><a href=\"http://6dragons.tk/index.html\">Home</a></th> <th><a href=\"http://www.mudportal.com/play?host=6dragons.tk&port=4100\">Play</a></th><th> <a href=\"http://6dragons.tk/bin/vote.html\">Vote</a> </th><th><a href=\"http://6dragons.tk/bin/staff.html\">Staff</a></th><th> <a href=\"http://6dragons.tk/bin/races.html\">Races</a> </th><th><a href=\"http://6dragons.tk/bin/classes.html\">Classes</a> </th><th> <a href=\"http://6dragons.tk/bin/guide.html\">Guide</a> </th><th><a href=\"http://6dragons.tk/news.html\">News</a></th><th> <a href=\"http://6dragons.tk/bin/story.html\">Story</a></th><th><th><a href=\"http://6dragons.tk/bin/wild.html\">Wilderness</a></th></tr></table>\n");
  fptof(fpout, "</div>\n");
  ...
  fptof(fpout, "</p>\n\n");
  fptof(fpout, "          <small>\n");
  fprintf(fpout, "Chronicles News System<a href=\"mailto:orion_elder@charter.net?subject=The Elder Chronicles News Snippet, %s\">Orion Elder</a>.<br>", sysdata.mud_name);
  fptof(fpout, "Download at<a href=\"http://www.geocities.com/knytehawk/smaug/index.html\" target=\"SSWRA\">The SSWRA</a>.<br>");
  fptof(fpout, "          </small>\n");
