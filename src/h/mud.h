...
#ifdef WIN32
#ifdef _CONSOLE /* this is a trick so mingw32 builds do not have a warning - MSVC defines 
                 * this for console - we are using it to detect a build from MSVC++ */
...
extern long long int    GUID;

#define MSL MAX_STRING_LENGTH /* Change MAX_STRING_LENGTH in mud.h */
#define MIL MAX_INPUT_LENGTH  /* Change MAX_INPUT_LENGTH in mud.h */
#define MFL	                 256

#define IS_ETHEREAL(ch) (( !IS_NPC((ch)) && (ch)->pcdata->learned[gsn_ethereal_body] > 0 ))
#define IS_DEXTERITY(ch) ( (ch)->Class == CLASS_THIEF || (ch)->Class == CLASS_MONK || (ch)->Class == CLASS_BARD || (ch)->secondclass == CLASS_THIEF || (ch)->thirdclass == CLASS_THIEF || (ch)->secondclass == CLASS_BARD || (ch)->thirdclass == CLASS_BARD )
#define IS_PASS(ch) ( IS_AFFECTED( ch, AFF_PASS_DOOR ) || xIS_SET( (ch)->act, PLR_SHADOWFORM )
...
#define MAX_QUEST	   500  /* Maximum amount of quests * * allowed */
...
#define MAX_VNUM      100000  /* Maximum room, object, and mobile vnum */
#define MAX_REXITS    20  /* Maximum exits allowed in 1 room */
#define MAX_SKILL     1000
#define MAX_CLASS     32
#define MAX_NPC_CLASS 32
#define STATED        200
/* MULTICLASS LEVEL DIFFERENCE */
#define MC_LD		8
#define MAX_LEVEL      108
#define MAX_CLASS_LVL  100  /* Used to support multi-class levels. -Taon */
...
#define MAX_WHERE_NAME 33
#define ADVDEATHLEVEL  10 /* Where advanced players stop perma dying! */
...
#define LEVEL_STAFF       (MAX_LEVEL - 7)
...
#define XBI  5  /* integers in an extended bitvector */
#define MAX_BITS  XBI * INTBITS

/* Structure for extended bitvectors -- Thoric */
struct extended_bitvector
{
  unsigned int            bits[XBI];  /* Needs to be unsigned to compile in Redhat 6 -
                                       * Samson */
};
...
struct race_type
{
  ...
  EXT_BV                  flags;  /* Special flags for Advanced races etc */
...
#define MOB_VNUM_GUARDS          41091
#define MOB_VNUM_WARRIORS        41092
// find familiar mobs
...
#define MOB_VNUM_DWARF           31378  /* Manoake Dwarven homeland teacher */

#define MOB_VNUM_MARLENA         1254 /* fake player */

/* Mid-level Teachers */
#define MOB_VNUM_DRAGON          26001  /* Nasty red dragon north of Paleon City */
...
typedef enum
{
  ACT_IS_NPC, ACT_SENTINEL, ACT_SCAVENGER, ACT_WATER, ACT_NOQUEST,
  ACT_AGGRESSIVE, ACT_STAY_AREA, ACT_WIMPY, ACT_PET, ACT_EMPTY1,
  ACT_PRACTICE, ACT_IMMORTAL, ACT_DEADLY, ACT_POLYSELF, ACT_WILD_AGGR,
  ...
  ACT_PROTOTYPE, ACT_HEALER, ACT_CARRY, ACT_GRALLOC, ACT_GROUP,
  ACT_QUESTMASTER, ACT_UNDERTAKER, ACT_OVERRIDE, ACT_ACLAN_LEADER, ACT_HCLAN_LEADER,
  ACT_PLAYER, ACT_NEWBPRACTICE, ACT_RESIZER, ACT_NCLAN_LEADER, ACT_QUESTGIVER,
  ACT_SIGILIST, ACT_CRAFTSHOP, ACT_SHIPWRIGHT, ACT_BEASTMELD, ACT_BEASTPET,
  ACT_BANKER, MAX_ACT
} act_types;
...
typedef enum
{
  AFF_BLINDNESS, AFF_INVISIBLE, AFF_COURAGE,
  AFF_DETECT_INVIS, AFF_BLINDING_SPEED, AFF_DETECT_HIDDEN,
  AFF_ENTHRALLED, AFF_SANCTUARY, AFF_FAERIE_FIRE,
  AFF_INFRARED, AFF_CURSE, AFF_SHIELD,
  AFF_POISON, AFF_PROTECT, AFF_PARALYSIS,
  AFF_SNEAK, AFF_HIDE, AFF_SLEEP,
  AFF_CHARM, AFF_FLYING, AFF_PASS_DOOR, // 21
  AFF_FLOATING, AFF_TRUESIGHT, AFF_DARK_BLESSINGS,
  ...
  AFF_THAITIN, AFF_SHRINK, AFF_R45, // 45
  AFF_R46, AFF_SURREAL_SPEED, AFF_BURROW,
  AFF_AGE, AFF_SILENCE, AFF_FEIGN, AFF_MANA_POOL, AFF_MAIM,
  AFF_REACTIVE, AFF_NETTLE, AFF_SLOW, AFF_WARD,
  AFF_ANOINT, AFF_FURY, AFF_BOOST, AFF_HYPNOTIZE,
  AFF_KINETIC,
  AFF_UNSEARING_SKIN,
  AFF_IRON_SKIN, AFF_INNER_STRENGTH, AFF_RECOIL, AFF_R67, // 67
  ...
  AFF_GREATER_RESTORE, AFF_ENERGY_CONTAINMENT,  // afflictions
  AFF_FUNGAL_TOXIN, AFF_BLISTERING, AFF_CLUMSINESS, AFF_CONFUSION, AFF_DIZZINESS,
  AFF_NAUSEA,
  AFF_MIGRAINE, AFF_FROSTBITE, AFF_ROTTEN_GUT, AFF_BRITTLE_BONES,
  AFF_SWELLING, AFF_ETHEREAL, AFF_NEUROTOXIN, AFF_TOXIN, AFF_CORROSIVE, // 102
  ...
  AFF_GRAZE,
  AFF_GRAFT, AFF_OTTOS_DANCE, // 120
  AFF_SOUND_WAVES, AFF_MOUNTED,
  AFF_PHASE, AFF_TANGLE, AFF_ARMOR, AFF_DISGUISE, AFF_ANIMALFORM, AFF_INFECTIOUS_CLAWS, AFF_SAGE_WISDOM, AFF_OGRE_VITALITY, // 128
  AFF_GAMBLERS_LUCK, AFF_GOBLIN_CUNNING, AFF_ELVEN_FEATURES, AFF_FELINE_GRACE, AFF_IMPRISONED, AFF_QUICK_BLADE, AFF_ADRENALINE, AFF_MAINTAIN_POSITION, AFF_HUNKER_DOWN, AFF_SPROUT_SPIKES,
  AFF_HAWK_SPIRIT, AFF_WOLF_SPIRIT, AFF_ENLARGE, AFF_INSANE, AFF_BEASTMELD, AFF_SEARING_HAZE, AFF_TAKEOVER, AFF_148, AFF_149, AFF_150,
  AFF_151, AFF_152, AFF_153, AFF_ANGELIC_BEING, AFF_VALTORS_SONG, AFF_TALKUP, AFF_TELEPATHY, AFF_DISABLED, AFF_MAGIC_MISSILE, AFF_WILLOW_SKIN,
  MAX_AFFECTED_BY
} affected_by_types;
...
#define RIS_PARALYSIS    BV21 /* 2097152 */
#define RIS_HACK         BV22 /* 4194304 */
#define RIS_LASH         BV23 /* 8388608 */
#define RIS_HIT          BV24 /* 16777216 */
#define RIS_R4           BV25
#define RIS_R5           BV26
#define RIS_R6           BV27
#define RIS_R7           BV28
...
typedef enum
{
  ATCK_BITE, ATCK_CLAWS, ATCK_TAIL_SWIPE, ATCK_STATICPULSE, ATCK_PUNCH, ATCK_KICK,
  ATCK_BACKHAND, ATCK_LOWBLOW, ATCK_STUN, ATCK_GOUGE, ATCK_BACKSTAB, ATCK_FEED,
  ATCK_DRAIN, ATCK_MENTALASSAULT, ATCK_BREATHE, ATCK_GUT,
  ATCK_IMPALE, ATCK_FROST, ATCK_POISON, ATCK_SLOW, ATCK_THROATPUNCH,
  ATCK_RAKE, ATCK_THAITIN, ATCK_JUDOCHOP, ATCK_SHRIEKINGNOTE,
  ATCK_MURAZORWHIP, ATCK_BUTTERFLYKICK, ATCK_SNATCH, ATCK_FIREBALL, ATCK_LIGHTNING,
  ATCK_WEAKEN, ATCK_PUGILISM, ATCK_INFERNO, ATCK_BLIZZARD, ATCK_EBOLT,
  ATCK_BLIGHTNING, ATCK_BRAINBOIL, ATCK_GSMITE, ATCK_HHANDS, ATCK_LTOUCH,
  ATCK_ELBOW, ATCK_CORROSIVE, ATCK_HEADBUTT, ATCK_FLYBY, ATCK_BLURATTACK, ATCK_CRANEKICK, ATCK_CRITIC, ATCK_PSIONICBLAST, ATCK_FEROCIOUSSTRIKE, ATCK_PLUCK,
  ATCK_ACIDSPRAY, ATCK_SWARM, ATCK_ASTRALATTACK, ATCK_PARALYZE, ATCK_FEAR, ATCK_STOMP, ATCK_BODYDROP, ATCK_MISTACID, ATCK_CREEPINGDOOM, ATCK_ARTERIES,
  ATCK_SPIKE, ATCK_QUIVERINGPALM, ATCK_THUNDEROUSHYMN, ATCK_24, ATCK_25, ATCK_26, ATCK_27, ATCK_28, ATCK_29, ATCK_30,
  MAX_ATTACK_TYPE
} attack_types;

typedef enum
{
  DFND_PARRY, DFND_DODGE, DFND_NETTLESKIN, DFND_SPECTRALWARD, DFND_TORPOR,
  DFND_KINETICBARRIER, DFND_DISPELMAGIC, DFND_HAWKSPIRIT, DFND_SANCTUARY,
  DFND_LICK, DFND_COMBATHEAL, DFND_SHIELD, DFND_WILLOWSKIN, DFND_GRENDALSTANCE,
  DFND_WOLFSPIRIT, DFND_REGENERATE, DFND_MAINTAINPOSITION, DFND_BIOFEEDBACK, DFND_HUNKERDOWN,
  DFND_DISARM, DFND_FINDWEAKNESS, DFND_BEARSPIRIT, DFND_MINORRESTORE, DFND_ACIDMIST,
  DFND_R25, DFND_R26, DFND_R27,
  DFND_R28, DFND_R29, DFND_R30, DFND_R31,
  DFND_R32, DFND_R33, MAX_DEFENSE_TYPE
} defense_types;
...
typedef enum
{
  ...
  ITEM_RESOURCE_BAG, ITEM_GATHER_BAG, ITEM_HUNTERS_BAG,
  ITEM_KIT,
  MAX_ITEM_TYPE
} item_types;
...
#define ITEM_WEAR_L_WING        BV27
#define ITEM_WEAR_R_WING        BV28
...
typedef enum
{
  ...
  WEAR_L_WING, WEAR_R_WING, MAX_WEAR
} wear_locations;
...
typedef enum
{
  ...
  PLR_ANSI, PLR_RIP, PLR_OBJID, PLR_FLEE, PLR_AUTOMONEY,
  ...
  PLR_LIFE, PLR_RP, PLR_R54, PLR_TEASE, PLR_BOAT, PLR_MUSIC, PLR_BATTLE, PLR_AUTOWAKE,
  PLR_EXTREME, PLR_NORENAME, PLR_COMMUNICATION, PLR_CRAFTS, PLR_R64, PLR_ENHANCED, PLR_KEEPALIVE, 
  PLR_R67, PLR_R68, PLR_R69, PLR_R70, PLR_R71, PLR_R72, PLR_R73,
  PLR_R74, PLR_R75, PLR_R76, PLR_R77,
...
#define PCFLAG_ENFORCER   BV20  /* Set an Immortal up as an Enforcer */
#define PCFLAG_BUILDER    BV21  /* Set an Immortal up as an Builder */
#define PCFLAG_TEMP       BV22  /* Set an Immortal up as an Roleplayer */
...
struct char_data
{
  ...
  PC_DATA                *pcdata;
  struct siege_data      *siege;  /* What siege does this */
  ...
  int                     money[MAX_CURR_TYPE];
  int                     gold;
  int                     exp;  /* Should be in PC_DATA, but I plan on mobs needing soon
                                 * -Orion */
  int                     firstexp;
  int                     secondexp;
  int                     thirdexp;
  ...
  short                   hate_level; /* Used for mobs to switch to ones with higher
                                       * number */
  short                   ward_dam; /* Used to determine if a ward has absorbed max
                                     * damage */
  short                   kinetic_dam;
  short                   color;
  short                   influence;  // chance a clan might gain
...
struct quest_data
{
  ...
  int                     level;  /* Minimum level needed to start the quest */
  int                     chapters; /* How many chapters? Big quest or small quest? */
  int                     svnum;  /* What vnum started this quest */
  short                   glory;
  short                   stype;  /* What type started it (0 = Mobile, 1 = Object, 2 =
                                   * Room) */
  bool                    skipchapters; /* Are they allowed to skip chapters? */
};
...
struct chap_data
{
  ...
  char                   *desc;
  char                   *bio;
  int                     timelimit;  /* Time limit for this chapter of the quest */
  int                     level;  /* Minimum level for this chapter of the quest */
  int                     kamount;  /* Amount they have to kill to complete this part of
                                     * the quest */
  char                   *phrase;
};
...
struct chquest_data
{
  ...
  int                     times;  /* Number of times player has attempted this quest */
  int                     kamount;  /* How many do they still have to kill */
};
...
struct bank_data
{
  ...
  char                   *name;
  char                   *password;
  time_t                  lastused; /* Lets keep track of when this bank last got used */
  int                     bronze;
  int                     copper;
  int                     gold;
  int                     silver;
...
struct pc_data
{
  NOTE_DATA              *gnote;
  CHAR_DATA              *pet;
  FOUND_AREA             *first_area, *last_area;
  CHQUEST_DATA           *first_quest, *last_quest;
  ...
  int                     flags;  /* Whether the player is deadly and whatever else we
                                   * add.  */
  ...
  int                     apply_blood;  /* Amount of blood to add to max blood */
  NUISANCE_DATA          *nuisance; /* New Nuisance structure */
  long int                restore_time; /* The last time the char did a restore all */
  long int                heaven_time;  /* The last time the char did a heavens blessing */
  ...
  short                   dlearned[MAX_SKILL];  /* This is for dragon's HUMAN FORM, to
                                                 * save a new set of skills heh */
  bool                    dshowlearned[MAX_SKILL];  /* Used for showing/not showing stuff 
                                                     * thats learned */
  bool                    dshowdlearned[MAX_SKILL]; /* Same as above for dragon's human
                                                     * form */
   ...
   * Samson 
   */
  int                     recast; /* for config recast */
  int                     recastsn; /* sn for what we are recasting */
  ...
  int                     holdbreath; /* How long a player has held their breath for */
  ...
  // level
  char                   *lastip; // used this for ip in whois
  /*
  ...
  short                   version;
  int                     invite; // the name of a house your allowed in
  int                     boatvnum; // used to switch to boat
  // view/room
  int                     watervnum;  // used to switch to water
  // view/room
  short                   ship; // which ship are they in?
  short                   direction;  // direction steer command sets
  // ship for
  short                   cansail;  // able to sail or under attack
  short                   hull; // percentage of ship hull integrity left
  short                   choice; // choice of animalform skill
  // Beast master stuff
  short                   petlevel;
  short                   petexp;
  short                   pethungry;
  short                   petthirsty;
  short                   petaffection;
  short                   pethp;  // stop pethp from changing on loadup
  int                     tmp_resist; // tradeskills
  short                   ac_penalty; // monks, bards, thieves if size != 77 armor items
  short                   monkblood;
  short                   mb; // also for monkblood skill
  char                   *combo1;
  char                   *combo2;
  char                   *combo3;
  char                   *coal1;
  ...
  char                   *coal3;
  short                   failsafe;
  char                   *account;  // save bank accounts to player file
};

/* Liquids. */
#define LIQ_WATER   0
#define LIQ_MAX    21 /* Added vomit and squishee, holywater */
...
struct obj_data
{
  ...
  RESET_DATA             *reset;
  struct siege_data      *siege;  /* What siege does this */
  struct city_data       *city; /* What city is this */
  char                   *name;
  char                   *short_descr;
  char                   *description;
  char                   *action_desc;
  ...
  char                   *whichcity;  // ability to see description of mob that was
  // killed prior on corpse
  long long int           guid;
};
...
struct system_data
{
  ...
  int                     numquotes;  /* Keep track of number of quotes here */
  ...
  short                   think_level;  /* Level of think channel LEVEL_MASTER */
  short                   build_level;  /* Level of build channel LEVEL_WORKER */
  ...
  short                   level_forcepc;  /* The level at which you can use force on
                                           * players. */
  short                   bestow_dif; /* Max # of levels between trust and command level
                                       * for a bestow to work --Blodkai */
  char                   *clan_overseer;  /* Pointer to char containing the name of the */
  ...
  short                   autoboot_hour;  /* What hour does the autoboot happen? */
  short                   autoboot_minute;  /* What minute does the autoboot happen? */
  short                   autoboot_period;  /* What period of days pass between
                                             * autoboots? */
...
extern short            gsn_infrasion;
extern short            gsn_frost;
extern short            gsn_hex;
extern short            gsn_freeze;
extern short            gsn_willow_skin;
extern short            gsn_pounce;
extern short            gsn_takeover;
extern short            gsn_disable;
extern short            gsn_mechanism;
extern short            gsn_creeping_doom;
extern short            gsn_swarm;
extern short            gsn_noscent;
extern short            gsn_story;
extern short            gsn_juggle;
extern short            gsn_talkup;
extern short            gsn_valtors_song;
extern short            gsn_morris_dance;
extern short            gsn_critic;
extern short            gsn_angelic_being;
extern short            gsn_confidence;
extern short            gsn_ward_of_ethereal;
extern short            gsn_ethereal_attack;
extern short            gsn_ethereal_body;
extern short            gsn_easy_victim;
extern short            gsn_cannibalize;
extern short            gsn_control;
extern short            gsn_marble_skin;

extern short            gsn_break;
extern short            gsn_brain_boil;
extern short            gsn_disguise;
extern short            gsn_double_slash;
extern short            gsn_mitigate;
extern short            gsn_density;
...
extern short            gsn_toxin;
extern short            gsn_migraine;
extern short            gsn_corrosive;
extern short            gsn_festering_wound;
extern short            gsn_dehydrate;
extern short            gsn_druidic_hymn;
extern short            gsn_shriek;
extern short            gsn_blur_attack;
extern short            gsn_blinding_speed;
extern short            gsn_quick_blade;
extern short            gsn_mistform;
extern short            gsn_hypnotize;
...
extern short            gsn_searing_haze;
extern short            gsn_flare;
extern short            gsn_torrent;
extern short            gsn_iceshard;
extern short            gsn_fumes;
extern short            gsn_hunker_down;
extern short            gsn_adrenaline_rush;
...
extern short            gsn_spirit_travel;
...
extern short            gsn_travel;
extern short            gsn_astral_attack;
...
extern short            gsn_low_blow;
extern short            gsn_throat_punch;

// Start of custom skills
extern short            gsn_butterfly_kick;
extern short            gsn_crane_kick;
extern short            gsn_combo;
extern short            gsn_coalesce;
extern short            gsn_knee;
extern short            gsn_ferocious_strike;
extern short            gsn_elbow;
extern short            gsn_bull_spirit;
extern short            gsn_bear_spirit;
extern short            gsn_wolf_spirit;
extern short            gsn_share;
extern short            gsn_infectious_claws;
extern short            gsn_net;
extern short            gsn_hone_claws;
extern short            gsn_find_water;
extern short            gsn_stalk_prey;
extern short            gsn_shroud_spirit;
extern short            gsn_tame;
extern short            gsn_beast_meld;
extern short            gsn_join;
extern short            gsn_crushing_jaw;
extern short            gsn_maul;
extern short            gsn_chilled_touch;
extern short            gsn_frost_touch;
extern short            gsn_icy_touch;
extern short            gsn_chilled_ward;
extern short            gsn_frost_ward;
extern short            gsn_ice_ward;
extern short            gsn_frigid_ward;
extern short            gsn_steed;
extern short            gsn_static_ward;
extern short            gsn_shocking_ward;
extern short            gsn_energy_ward;
extern short            gsn_lightning_ward;
extern short            gsn_poultice;
extern short            gsn_tend;
extern short            gsn_combat_heal;
extern short            gsn_effloresce;
extern short            gsn_sylvan_touch;
extern short            gsn_mend;
extern short            gsn_animal_form;
extern short            gsn_bat_form;
...
extern short            gsn_clawed_hands;
extern short            gsn_body_drop;
extern short            gsn_inner_strength; // Taon
extern short            gsn_courage;
extern short            gsn_feed;
extern short            gsn_gorge;
extern short            gsn_mistwalk;
extern short            gsn_forge;
extern short            gsn_mill;
extern short            gsn_jewelry;
extern short            gsn_tan;
extern short            gsn_hunt;
extern short            gsn_mix;
extern short            gsn_crafted_food1;
extern short            gsn_crafted_food2;
extern short            gsn_crafted_food3;
extern short            gsn_crafted_drink1;
extern short            gsn_crafted_drink2;
extern short            gsn_crafted_drink3;
...
extern short            gsn_regenerate;
extern short            gsn_serenity;
...
#define BEASTMELD(ch) ( IS_NPC((ch)) && ((ch)->desc && (ch)->desc->original ) && xIS_SET( (ch)->act, ACT_BEASTMELD ))
...
#define IS_STAFF(ch)  (get_trust((ch)) >= LEVEL_STAFF && !IS_NPC(ch))
...
#define GET_HITROLL(ch) (((ch)->race == RACE_DRAGON ? ((ch)->height / 6) : 0) + (ch)->hitroll + str_app[get_curr_str((ch))].tohit + (2-(abs((ch)->mental_state)/10)))

#define GET_DAMROLL(ch) ((((ch)->race == RACE_DRAGON && !IS_NPC((ch))) ? ((ch)->height / 6) : 0) \
...
#define CMD_FULLNAME  BV07  /* Commands flagged with this must be typed entirely */
...
/* Ship sailing commands */
DECLARE_DO_FUN(do_aboard);
DECLARE_DO_FUN(do_deed);
DECLARE_DO_FUN(do_deal);
DECLARE_DO_FUN(do_hull_repair);
DECLARE_DO_FUN(do_view);
DECLARE_DO_FUN(do_pilot);
DECLARE_DO_FUN(do_steer);
DECLARE_DO_FUN(do_sail);
DECLARE_DO_FUN(do_depart);
DECLARE_DO_FUN(do_mpboat);  // assign a boat to a player
DECLARE_DO_FUN(do_mist_acid);
DECLARE_DO_FUN(do_acid_spray);
...
DECLARE_DO_FUN(do_blur_attack);
DECLARE_DO_FUN(do_blinding_speed);
DECLARE_DO_FUN(do_quick_blade);
DECLARE_DO_FUN(do_mistform);
DECLARE_DO_FUN(do_hypnotize);
...
DECLARE_DO_FUN(do_astral_attack);
...
DECLARE_DO_FUN(do_ethereal_attack);
...
DECLARE_DO_FUN(do_toxin);
DECLARE_DO_FUN(do_migraine);
DECLARE_DO_FUN(do_corrosive);
...
DECLARE_DO_FUN(do_downward_slash);
DECLARE_DO_FUN(do_overhead_slash);
DECLARE_DO_FUN(do_check_vnums);
DECLARE_DO_FUN(do_checksieges);
...
DECLARE_DO_FUN(do_coalesce);
DECLARE_DO_FUN(do_effloresce);
DECLARE_DO_FUN(do_sylvan_touch);
...
DECLARE_DO_FUN(do_angelic_being);
DECLARE_DO_FUN(do_story);
DECLARE_DO_FUN(do_juggle);
DECLARE_DO_FUN(do_talkup);
DECLARE_DO_FUN(do_valtors_song);
DECLARE_DO_FUN(do_morris_dance);
DECLARE_DO_FUN(do_critic);
DECLARE_DO_FUN(do_connect);
DECLARE_DO_FUN(do_consider);
DECLARE_DO_FUN(do_cook);
DECLARE_DO_FUN(do_copyover);  /* Copyover command - Samson 3-31-01 */
DECLARE_DO_FUN(do_councils);
DECLARE_DO_FUN(do_forge);
DECLARE_DO_FUN(do_mill);
DECLARE_DO_FUN(do_jewelry);
...
DECLARE_DO_FUN(do_inner_strength);  // Taon
DECLARE_DO_FUN(do_courage);
DECLARE_DO_FUN(do_drag);
DECLARE_DO_FUN(do_draw);
DECLARE_DO_FUN(do_dream_walk);
DECLARE_DO_FUN(do_spirit_travel);
...
DECLARE_DO_FUN(do_creeping_doom);
DECLARE_DO_FUN(do_swarm);
DECLARE_DO_FUN(do_willow_skin);
DECLARE_DO_FUN(do_pounce);
DECLARE_DO_FUN(do_takeover);
DECLARE_DO_FUN(do_disable);
DECLARE_DO_FUN(do_mechanism);
DECLARE_DO_FUN(do_infrasion);
DECLARE_DO_FUN(do_fshow);
DECLARE_DO_FUN(do_ftick);
DECLARE_DO_FUN(do_frigid_touch);  // Vladaar
...
DECLARE_DO_FUN(do_minor_restore); // Taon
...
DECLARE_DO_FUN(do_klive);
DECLARE_DO_FUN(do_hide);
DECLARE_DO_FUN(do_fumes);
DECLARE_DO_FUN(do_hunker_down);
DECLARE_DO_FUN(do_maintain_position);
DECLARE_DO_FUN(do_adrenaline_rush);
...
DECLARE_DO_FUN(do_low_blow);
DECLARE_DO_FUN(do_throat_punch);
DECLARE_DO_FUN(do_chill);
DECLARE_DO_FUN(do_frost);
DECLARE_DO_FUN(do_hex);
DECLARE_DO_FUN(do_afreeze);
// start of custom skills
DECLARE_DO_FUN(do_butterfly_kick);
DECLARE_DO_FUN(do_crane_kick);
DECLARE_DO_FUN(do_knee);
DECLARE_DO_FUN(do_ferocious_strike);
DECLARE_DO_FUN(do_elbow);
DECLARE_DO_FUN(do_bull_spirit);
DECLARE_DO_FUN(do_bear_spirit);
DECLARE_DO_FUN(do_wolf_spirit);
DECLARE_DO_FUN(do_share);
DECLARE_DO_FUN(do_infectious_claws);
DECLARE_DO_FUN(do_net);
DECLARE_DO_FUN(do_hone_claws);
DECLARE_DO_FUN(do_find_water);
DECLARE_DO_FUN(do_stalk_prey);
DECLARE_DO_FUN(do_shroud_spirit);
DECLARE_DO_FUN(do_tame);
DECLARE_DO_FUN(do_beast_meld);
DECLARE_DO_FUN(do_join);
DECLARE_DO_FUN(do_maul);
DECLARE_DO_FUN(do_chilled_touch);
DECLARE_DO_FUN(do_frost_touch);
DECLARE_DO_FUN(do_icy_touch);
DECLARE_DO_FUN(do_steed);
DECLARE_DO_FUN(do_poultice);
DECLARE_DO_FUN(do_tend);
DECLARE_DO_FUN(do_combat_heal);
DECLARE_DO_FUN(do_mend);
DECLARE_DO_FUN(do_animal_form);
DECLARE_DO_FUN(do_bat_form);
DECLARE_DO_FUN(do_heavy_hands);
DECLARE_DO_FUN(do_clawed_hands);
...
DECLARE_DO_FUN(do_pet_companion);
...
DECLARE_DO_FUN(do_unearth);
DECLARE_DO_FUN(do_produce);
DECLARE_DO_FUN(do_fell);
DECLARE_DO_FUN(do_minvoke);
DECLARE_DO_FUN(do_mistwalk);
DECLARE_DO_FUN(do_mlist);
DECLARE_DO_FUN(do_bankers); // Volk Jan-16: Added
DECLARE_DO_FUN(do_merge); // Volk Jan-16: Added
DECLARE_DO_FUN(do_balance); // Volk Jan-16: Added
...
DECLARE_DO_FUN(do_petreport);
DECLARE_DO_FUN(do_petdescribe);
...
DECLARE_DO_FUN(do_sprout_spikes);
DECLARE_DO_FUN(do_hawk_spirit);
...
DECLARE_DO_FUN(do_talk_to_char);
...
DECLARE_DO_FUN(do_spectral_ward);
DECLARE_DO_FUN(do_confidence);
DECLARE_DO_FUN(do_ward_of_ethereal);
...
DECLARE_DO_FUN(do_forward_charge);
...
// Custom spells
DECLARE_SPELL_FUN(spell_chilled_ward);
DECLARE_SPELL_FUN(spell_frost_ward);
DECLARE_SPELL_FUN(spell_ice_ward);
DECLARE_SPELL_FUN(spell_frigid_ward);
DECLARE_SPELL_FUN(spell_static_ward);
DECLARE_SPELL_FUN(spell_shocking_ward);
DECLARE_SPELL_FUN(spell_static_pulse);
DECLARE_SPELL_FUN(spell_energy_ward);
DECLARE_SPELL_FUN(spell_lightning_ward);
...
DECLARE_SPELL_FUN(spell_stick);
DECLARE_SPELL_FUN(spell_iceshard);
DECLARE_SPELL_FUN(spell_battlefield_view);
DECLARE_SPELL_FUN(spell_bestow_vitae);
DECLARE_SPELL_FUN(spell_torpor);
DECLARE_SPELL_FUN(spell_spirit_wolf);
DECLARE_SPELL_FUN(spell_sylvan_wind);
DECLARE_SPELL_FUN(spell_blindness);
DECLARE_SPELL_FUN(spell_burning_hands);
DECLARE_SPELL_FUN(spell_call_lightning);
DECLARE_SPELL_FUN(spell_cause_critical);
DECLARE_SPELL_FUN(spell_cause_light);
DECLARE_SPELL_FUN(spell_kolaks_stand);
DECLARE_SPELL_FUN(spell_lightning);
...
DECLARE_SPELL_FUN(spell_dark_blessings);
DECLARE_SPELL_FUN(spell_dispel_evil);
DECLARE_SPELL_FUN(spell_dispel_magic);
DECLARE_SPELL_FUN(spell_greater_restore); // Taon
DECLARE_SPELL_FUN(spell_searing_light); // Taon
...
DECLARE_SPELL_FUN(spell_wind_attack);
DECLARE_SPELL_FUN(spell_firestorm);
DECLARE_SPELL_FUN(spell_flamestrike);
DECLARE_SPELL_FUN(spell_gate);
DECLARE_SPELL_FUN(spell_knock);
DECLARE_SPELL_FUN(spell_sage_wisdom);
DECLARE_SPELL_FUN(spell_gamblers_luck);
DECLARE_SPELL_FUN(spell_goblin_cunning);
DECLARE_SPELL_FUN(spell_elven_features);
DECLARE_SPELL_FUN(spell_ogre_vitality);
DECLARE_SPELL_FUN(spell_feline_grace);
DECLARE_SPELL_FUN(spell_imprisonment);
...
void sound_to_char      args((const char *fname, int vol, int repeats, int priority, const char *type, const char *url, CHAR_DATA *ch));
void music_to_char      args((const char *fname, int vol, int repeats, int continu, const char *type, const char *url, CHAR_DATA *ch));
...
bool empty_obj          args((OBJ_DATA *obj, OBJ_DATA *destobj, ROOM_INDEX_DATA *destroom, bool skelerot));
...
bool load_char_obj      args((DESCRIPTOR_DATA *d, char *name, bool preload, bool copyover, bool quiet));
void set_alarm          args((long seconds));
void requip_char        args((CHAR_DATA *ch));
void fwrite_obj         args((CHAR_DATA *ch, OBJ_DATA *obj, FILE * fp, int iNest, short os_type, bool copyover));
...
#define MXP_locked 2  /* no MXP or HTML commands are allowed in the line.  The line is
                       * not parsed for any tags at all.  */
...
bool                    IS_AFFECTED2(CHAR_DATA *ch, int arg);
