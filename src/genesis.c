...
// ************ This portion code added by Vladaar to check to see if blind?  ********
      switch (argument[0])
      {
        ...
        case 'Y':
          ...
          write_to_buffer(d, "\r\nHave a listen to our welcome audio if you are new here.\r\nhttp://6dragons.tk/intro.mp3", 0);
          break;
        case 'n':
        case 'N':
          break;
    ...
    case CON_ENTER_GAME:
      ...
      if(ch->level == 0)
      {
        ...
        ch->pcdata->age_bonus = 0;
                ...
                set_title( ch, (char *)"the young adventurer" );
        /*
...
/* Volk: Bring back pets.. */
      ...
      if(ch->level > 1)
      {
        ...
        {
          send_to_char("&Y6Dragons HAPPY HOUR is currently under way!\r\n", ch);
